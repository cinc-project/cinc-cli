...
var cliFamily = family{cases: []testCase{
	...
	{"cli/config-create-symlinked-file", []string{"config create", "node list"}, testConfigCreateSymlinkedFile},
	...
	{"cli/migration-then-validate", []string{"config validate"}, testMigrationThenValidate},
	{"cli/migration-leaves-chef-file-alone", []string{"node list"}, testMigrationLeavesChefFileAlone},
	{"cli/migration-carried-settings-work", []string{"config validate", "databag secret create"}, testMigrationCarriedSettingsWork},
	...
	{"cli/migration-unusable-chef-file", []string{"node list"}, testMigrationUnusableChefFile},
